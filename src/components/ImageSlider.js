...
function ImageSlider() {
  return (
    ...
    <Carousel>
      ...
      <img src='/assests/image/slide2.jpg' style={{width:'100%',height:'550px'}}  alt="slide1" />
        <Carousel.Caption>
      ...
      <img src='/assests/image/slide11.jpg'  style={{width:'100%',height:'550px'}}   alt="slide2"  />
      ...
      <Carousel.Item >
      <img src='/assests/image/slide3.jpg'style={{width:'100%',height:'550px'}}   alt="slide3"  />
      ...
      <Carousel.Item interval={1000} >
      <img src="/assests/image/slide4.webp" style={{width:'100%',height:'550px'}}  alt="slide4" />
        <Carousel.Caption>
      ...
      <Carousel.Item interval={500} >
      <img src="/assests/image/slide5.jpg" style={{width:'100%',height:'550px'}}  alt="slide5" />
        <Carousel.Caption>
          <h3>Fly-Bharat</h3>
...
<h3 style={{color:'#0047AB', textAlign:'center'}}>----Stories-----</h3>
    <CardGroup>
       <Card>
        <Card.Img variant="top" style={{height:'300px'}} src="/assests/image/kashmir.jpg"/>
        <Card.Body>
...
<Figure>
      ...
      <Card>
        <Card.Img variant="top" style={{height:'300px'}} src="/assests/image/taj.jpg" />
        <Card.Body>
    ...
    <Accordion defaultActiveKey="0">
      <Accordion.Item eventKey="0">
        ...
        Agra Mall Road between 10:00 am and 06:00 pm. The price for an adult Indian tourist is INR 510,
         ...
         But there are ways of making the visit more rewarding. But there are ways of making the visit more rewardingThe key thing is to visit at the right time of year:
...
<Figure>
      ...
      <Card>
        <Card.Img variant="top" style={{height:'300px'}} src="/assests/image/Hoi.jpg" />
        <Card.Body>
